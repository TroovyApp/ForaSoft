...
open class DKImagePickerController : UINavigationController {
    ...
    override open func viewWillAppear(_ animated: Bool) {
        ...
        if !hasInitialized {
            ...
            let attributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey.font : UIFont.systemFont(ofSize: 17.0, weight: .semibold),
                                                                  NSAttributedStringKey.foregroundColor : UIColor.black]
            self.navigationBar.titleTextAttributes = attributes
            
            self.navigationBar.barTintColor = UIColor(red: 249.0 / 255.0, green: 249.0 / 255.0, blue: 249.0 / 255.0, alpha: 1.0)
            self.navigationBar.backgroundColor = UIColor(red: 249.0 / 255.0, green: 249.0 / 255.0, blue: 249.0 / 255.0, alpha: 1.0)
