...
open class CustomModalTransition: NSObject {
  ...
  public func finishAnimation(completion: ((_ finished: Bool) -> Void)?) {
    let success = !(self.transitionContext?.transitionWasCancelled ?? true)
  ...
  public func beginInteractiveDismissalTransition(completion: (() -> Void)?) {
    ...
    self.owningController?.dismiss(animated: true, completion: completion)
  }
  ...
  public func cancelInteractiveTransition() {
    ...
    self.interactionController?.completionSpeed = 0.999 // http://stackoverflow.com/a/22968139/188461
